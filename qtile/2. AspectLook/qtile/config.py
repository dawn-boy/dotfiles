...
keys = [
    ...
    Key([mod, "shift"], "w", lazy.spawn("python /home/Dew/wallch.py",shell=True), desc="Reloads the walls"),
    ...
    Key([mod], "p", lazy.spawn('python /home/Dew/wallch.py'), desc="Spawn a command using a prompt widget"),
